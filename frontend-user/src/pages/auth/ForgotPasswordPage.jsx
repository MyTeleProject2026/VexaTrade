...
export default function ForgotPasswordPage() {
  ...
  // ⬇️ JSX exactly as you had it originally
  return (
          ...
          <div className="relative z-10 flex w-full flex-col justify-between p-10 xl:p-14">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-5">
                ...
                <div className="mt-3 text-2xl font-semibold text-white">OTP verification</div>
              </div>
              <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-5">
                <div className="text-xs uppercase tracking-[0.28em] text-slate-500">Fast</div>
                <div className="mt-3 text-2xl font-semibold text-white">Email reset link</div>
              </div>
            </div>
          </div>
        </section>
