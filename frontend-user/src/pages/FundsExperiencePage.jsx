 ...
 return <div className="min-h-screen bg-[#050812] pb-20">
  <div className="mx-auto max-w-7xl px-3 pt-3 sm:px-5">
   <div className="mb-2 flex flex-wrap gap-1.5 overflow-x-auto">
    {links.map(([href,label,Icon])=><a key={href} href={href} className="inline-flex shrink-0 items-center gap-1.5 rounded-lg border border-white/10 bg-white/[0.025] px-2.5 py-1.5 text-[10px] font-semibold text-slate-300 hover:border-cyan-400/30 hover:text-cyan-300"><Icon size={11}/>{label}</a>)}
