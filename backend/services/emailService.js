...
<body>
  <div class="container">
    <div class="card">
      ...
      <!-- Button -->
      <div style="text-align: center;">
        <a href="https://www.vexatrade-v.2bd.net/activity" class="button">
          View in App
        </a>
      </div>
      ...
      <div class="footer">
        <p>
          ...
          <a href="https://www.vexatrade-v.2bd.net/support">support team</a>.
        </p>
        <p style="margin-top: 8px;">
          <a href="https://www.vexatrade-v.2bd.net/privacy">Privacy Policy</a> ·
          <a href="https://www.vexatrade-v.2bd.net/terms">Terms of Service</a>
        </p>
