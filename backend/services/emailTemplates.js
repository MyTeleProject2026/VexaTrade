    ...
    <div class="card">
      ...
      <div class="message">
        ...
        <span style="color: #64748b; font-size: 14px;">
          This message was sent by the VexaTrade Blockchain Ecosystem.
        </span>
      </div>

      <!-- Button -->
      <div style="text-align: center;">
        <a href="https://vexatrade-v.2bd.net/activity" class="button">
          View in App
        </a>
      </div>
      ...
      <div class="footer">
        <p>
          This is an automated notification from <a href="https://vexatrade-v.2bd.net">VexaTrade</a>.
          <br>
          If you have any questions, please contact our 
          <a href="https://vexatrade-v.2bd.net/support">support team</a>.
        </p>
        <p style="margin-top: 8px;">
          <a href="https://vexatrade-v.2bd.net/privacy">Privacy Policy</a> ·
          <a href="https://vexatrade-v.2bd.net/terms">Terms of Service</a>
        </p>
