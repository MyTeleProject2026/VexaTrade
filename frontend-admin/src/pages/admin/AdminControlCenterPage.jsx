...
const CHECK_TO_MODULE = {
  users: "users", kyc: "kyc", deposits: "deposits", depositNetworks: "depositNetworks", depositVerification: "depositVerification",
  withdrawals: "withdrawals", withdrawalFees: "withdrawalFees", withdrawalSettings: "withdrawalSettings", profitWithdrawals: "profitWithdrawals",
  loans: "loans", loanSettings: "loanSettings", funds: "funds", fundRules: "fundRules", settings: "settings", audit: "audit",
  support: "support", tradeRules: "tradeRules", tradeOutcomeQueue: "tradeOutcomeQueue", news: "news", legal: "legal",
  jointRequests: "jointRequests", jointAccounts: "jointAccounts", assets: "assets", assetLedger: "assetLedger",
  assetRegistry: "assetRegistry", networks: "networks", trades: "trades",
};
